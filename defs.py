...
PATH_ITERS = 5000 # Number of iterations to optimize too
...
TRACK_CONTACT_ANGLE = np.pi/5 # Angle between path and support points
...
Z_DIFF_MAX = 30 # Z difference of max repulsion force
POS_DIFF_MIN = MARBLE_RAD*1.5 # XY diff of min repulsion force
